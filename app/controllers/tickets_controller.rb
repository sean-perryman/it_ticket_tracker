class TicketsController < ApplicationController
  ...
  def create 
    ...
    temp_ticket_params[:date_occurred] = temp_ticket_params[:date_occurred].to_formatted_s(:db)
  ...
  def update
    temp_ticket_params = ticket_params
    temp_ticket_params[:date_submitted] = temp_ticket_params[:date_submitted].to_formatted_s(:db)
    temp_ticket_params[:date_occurred] = temp_ticket_params[:date_occurred].to_formatted_s(:db)
    temp_ticket_params[:date_resolved] = temp_ticket_params[:date_resolved].to_formatted_s(:db)
